 ...
 *
 * @version V1.0
 * @FileName: com.woosiyuan.faceattendance.basis.db.util.GreenDaoContext.java
 * @author: so
 * @date: 2018-01-22 09:27
 */
...
public class GreenDaoContext  extends ContextWrapper {
    ...
    public GreenDaoContext() {
        super(MyApplication.getINSTANCE().getBaseContext());
    ...
    public File getDatabasePath(String dbName) {
        String dbDir = DirectoryManager.getDbDirPath();
